...
class SqlParserSpec extends BaseSpec {
  ...
  it must s"parse a ${clazz[IsNullExpression]}" in {
  ...
  it must s"parse ${clazz[Concat]} function" in {
  ...
  it must s"parse ${clazz[ConcatWs]} function" in {
  ...
  it must s"parse ${clazz[LeftOrRightPad]} function" in {
  ...
  it must s"parse ${clazz[Substring]} function" in {
  ...
  it must s"parse ${clazz[ToDateOrTimestamp]} function" in {
