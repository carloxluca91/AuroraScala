...
object ScoptOption extends Enumeration {
  ...
  val DataSource: Val = Val('s', "datasource", "Datasource to be ingested")
  ...
  val CompleteOverwriteFlag: Val = Val('o', "overwrite", "Flag for specifying behavior when reloading tables. " +
